define([], function () {
  return {
    PropertyPaneDescription:
      "This webpart displayes a group of tiles which can be set to navigate to different URLs",
    TilesListDescription:
      "The list for configuring the tiles can be found on the following link:",
